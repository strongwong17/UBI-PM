        ...
        >
          <div>
            ...
            <p className="text-[13px] text-ink-500 m-0 max-w-[520px]">
              Update template body, exhibits, and dynamic fields. Changes apply to future
              generated contracts.
            </p>
          </div>
        </div>
              ...
              <div className="space-y-1.5">
                ...
                {showPreview ? (
                  ...
                  <textarea
                    ...
                    rows={20}
                    className="w-full px-3 py-2 rounded-md font-mono text-[12px] text-ink-900 outline-none focus:ring-2 focus:ring-ink-900/10 resize-none"
                    style={{
                      background: "var(--color-card-rd)",
                      border: "1px solid var(--color-hairline)",
                    }}
          ...
          <div>
            ...
            >
              ...
              <p className="text-[12px] leading-relaxed text-ink-700">
                ...
                for dynamic fields in body and exhibits.
              </p>
            </div>
          </div>
