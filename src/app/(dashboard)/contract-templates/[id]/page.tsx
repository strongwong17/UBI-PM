...
export default function EditTemplatePage() {
  ...
  const updateTemplate = useContractStore((s) => s.updateTemplate);
            ...
            <div>
              ...
              {showPreview ? (
                ...
                <textarea
                  ...
                  rows={20}
                  className="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 font-mono text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
                />
              )}
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-950">
            ...
            <p className="text-xs leading-relaxed text-blue-600 dark:text-blue-400">
              Use <code className="rounded bg-blue-100 px-1 py-0.5 dark:bg-blue-900">{"{{field_name}}"}</code> for
              dynamic fields. Works in both main content and exhibits.
            </p>
          </div>
